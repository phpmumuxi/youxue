<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"D:\wamp64\web\youxue\public/../application/admin\view\finance_statistics\shopStatistics.html";i:1521799116;s:65:"D:\wamp64\web\youxue\public/../application/admin\view\layout.html";i:1521799117;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
        ...
        <span>
            <select id="shopId" style='border:0;background:white none repeat scroll 0 0;'>
...
function loadData(type,aTime,bTime){
    ...
    $.ajax({
        ...
        data:{type:type,aTime:aTime,bTime:bTime,shopId:shopId,action:'shop'},
        dataType:'JSON',
